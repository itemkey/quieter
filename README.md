...
- сбор стартовых камней и веток, крафт примитивной кирки, добыча камня и десяти
  видов залежей с богатством, запасами, качеством, твёрдостью и примесями;
- личная разведка залежей удержанием `E`, износ инструмента, неопознанные
  образцы, постоянное истощение ресурсов и карта разведки на `M`;
...
Основные команды в мире: `Tab` — инвентарь, `Q` — верстак, `M` — карта,
`E` — подобрать или исследовать, ЛКМ — удар активной киркой. Инвентарь,
верстак и карта открываются взаимоисключающе.
